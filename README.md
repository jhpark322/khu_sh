...
- **Kakao Maps SDK** — 지도는 위치 맥락을 보여주고, 노래 재생 시작 지점을 트랙 마커로 표시
- **인디코인 경제** — 추천 음악 70% 감상 시 +10 IC, 별점 피드백으로 인디코인 적립, 코인샵에서 후원·굿즈 구매
- **크리에이터 대시보드** — 발견·해제·별점·후원 메트릭 실시간 집계
...
| POST | `/api/review`            | 별점 피드백 저장 + 인디코인 |
| POST | `/api/spend`             | 인디코인 사용 (아티스트 후원, 굿즈 구매) |
